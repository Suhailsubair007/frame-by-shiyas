    ...
    >
      <div class="flex items-center gap-5">
        <a
          ...
          class="group flex items-center gap-2 font-mono text-[10px] uppercase tracking-widest text-text-faint transition-colors duration-300 hover:text-accent"
          :tabindex="isOpen ? 0 : -1"
        >
          <svg
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          class="group flex items-center gap-1 font-mono text-[10px] uppercase tracking-widest text-text-faint transition-colors duration-300 hover:text-accent"
          :tabindex="isOpen ? 0 : -1"
        >
          Additional Works
          <span
